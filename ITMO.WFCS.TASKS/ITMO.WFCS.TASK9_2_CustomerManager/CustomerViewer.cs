...
using ITMO.WFCS.TASK9_2_CodeFirst;
...
namespace ITMO.WFCS.TASK9_2_CustomerManager
    ...
    public partial class CustomerViewer : Form
        ...
        private void buttonAdd_Click(object sender, EventArgs e)
            ...
            C1.Orders = orderlistBox.SelectedItems.OfType<Order>().ToList();
            }
        ...
        private void Output() { if (this.CustomerradioButton.Checked == true)
        ...
        private void CustomerViewer_Load(object sender, EventArgs e)
            ...
            context.Orders.Add(new Order { ProductName = "Видео", Quantity = 22, PurchaseDate = DateTime.Parse("10.01.2016") }); context.SaveChanges(); orderlistBox.DataSource = context.Orders.ToList();
            }

        private void orderGridView_CellClick(object sender, DataGridViewCellEventArgs e)
            {
            if (GridView.CurrentRow == null) return;
            var customer = GridView.CurrentRow.DataBoundItem as Customer; if (customer == null) return;
            labelid.Text = Convert.ToString(customer.CustomerId); textBoxCustomer.Text = customer.ToString();
            textBoxname.Text = customer.FirstName; textBoxlastname.Text = customer.LastName; textBoxmail.Text = customer.Email;
        ...
        private void buttonEdit_Click(object sender, EventArgs e)
            ...
            customer.FirstName = this.textBoxname.Text; customer.LastName = this.textBoxlastname.Text; customer.Email = this.textBoxmail.Text; customer.Age = Int32.Parse(this.textBoxage.Text);
        ...
        private void buttonDel_Click(object sender, EventArgs e)
            ...
            context.Entry(customer).State = EntityState.Deleted; context.SaveChanges(); Output();
            }
        }
 }
