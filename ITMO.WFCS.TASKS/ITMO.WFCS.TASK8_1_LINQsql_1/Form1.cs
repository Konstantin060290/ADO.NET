...
namespace ITMO.WFCS.TASK8_1_LINQsql_1
{
    public partial class Form1 : Form
    {
        ...
        DataContext db=new DataContext(@"Server=(LocalDB)\MSSQLLocalDB; Integrated Security=true; AttachDbFileName=D:\Coding\ITMO\7_ADO_NET\Tasks\ITMO.WFCS.TASKS\Northwind.mdf");
