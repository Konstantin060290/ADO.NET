...
namespace ITMO.WFCS.TASKS4_3_DataAdapterProgram
{
    public partial class Form1 : Form
    {
       
        static SqlConnection NorthwindConnection = new SqlConnection(@"Server=(LocalDB)\MSSQLLocalDB; Integrated Security=true; AttachDbFileName=D:\Coding\ITMO\7_ADO_NET\Tasks\ITMO.WFCS.TASKS\Northwind.mdf");
        ...
        {
            NorthwindDataset.EndInit();
            var index = dataGridView1.CurrentRow.Index; NorthwindDataset.Tables["Customers"].Rows[index].Delete();
            SqlDataAdapter1.Update(NorthwindDataset.Tables["Customers"]);
        }
    }
}
