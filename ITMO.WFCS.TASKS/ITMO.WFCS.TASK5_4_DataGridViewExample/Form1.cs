...
namespace ITMO.WFCS.TASK5_4_DataGridViewExample
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            DataColumn Location = new DataColumn("Location"); Location.Expression = "City + ',' + Country";
        ...
        private void AddColumnButton_Click(object sender, EventArgs e)
        {
            ...
            LocationColumn.Name = "LocationColumn"; LocationColumn.HeaderText = "Location";
...
customersDataGridView.CurrentCell.OwningColumn.DataPropertyName + Environment.NewLine;
        ...
        private void customersDataGridView_CellValidating(object sender, DataGridViewCellValidatingEventArgs e)
        {
            ...
            { if (e.FormattedValue.ToString() == "") { customersDataGridView.Rows[e.RowIndex].ErrorText = "ContactName is a required field";
                    e.Cancel = true; } else customersDataGridView.Rows[e.RowIndex].ErrorText = ""; }
        }

        private void ApplyStyleButton_CheckedChanged(object sender, EventArgs e)
        {
            if (ApplyStyleButton.Checked == true) customersDataGridView.AlternatingRowsDefaultCellStyle.BackColor = Color.LightGray; else customersDataGridView.AlternatingRowsDefaultCellStyle.BackColor = Color.White;
