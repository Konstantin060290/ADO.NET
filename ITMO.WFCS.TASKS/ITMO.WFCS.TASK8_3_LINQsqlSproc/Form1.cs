...
namespace ITMO.WFCS.TASK8_3_LINQsqlSproc
{
    public partial class Form1 : Form
    {
        Northwnd db = new Northwnd(@"Server=(LocalDB)\MSSQLLocalDB; Integrated Security=true; AttachDbFileName=D:\Coding\ITMO\7_ADO_NET\Tasks\ITMO.WFCS.TASKS\Northwind.mdf");
        public Form1()
        {
            InitializeComponent();
        }
