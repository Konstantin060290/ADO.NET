...
namespace ITMO.WFCS.TASK1_DBConnection
{
    ...
    {
        //string connectionString = @"Server=(LocalDB)\MSSQLLocalDB; Integrated Security=true; AttachDbFileName=D:\Coding\ITMO\7_ADO_NET\Tasks\ITMO.WFCS.TASK1\Northwind.mdf";
        public Form1()
        {
            InitializeComponent();
        ...
        private void gjlToolStripMenuItem_Click(object sender, EventArgs e)
        {
